...
public class Test006
{
	...
	{
		// 변수 선언 (지역 변수 a)		메소드 영역안에서 선언한 변수를 '지역변수'라 한다.
		int a;
		...
		// =====>> c의 결과 : 10
		 ...
		 //접미사『L』이 중요하다.
		 //long형은 숫자(상수)뒤에 『L』 또는 『l』을 붙여 상수를 표현해야 한다.
		 //즉, 약 21억 이사 되는 상수에는 뒤에 저미사를 꼭 붙여 줄수 있도록 한다.
